...
<template>
  <section>
    ...
    <CommonBanner title="¿En qué podemos ayudarte?"
    ...
    <div class="mt-12 w-full lg:mb-32">
      ...
      <div class="grid gap-8 md:grid-cols-[1fr_33%] lg:grid-cols-[1fr_25rem] lg:gap-12 mt-6">
        <div class="ring-1 ring-offset-8 ring-[#E6E7E8] rounded-md">
          <UAccordion class="rounded-xl" color="transparent" size="xl" :items="response" :ui="{
            wrapper: 'gap-6',
            container:
